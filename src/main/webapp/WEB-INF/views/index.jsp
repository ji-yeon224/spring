			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarCollapse">
					<ul class="navbar-nav me-auto mb-2 mb-md-0">
						<li class="nav-item"> 
						<a class="nav-link active" aria-current="page" href="<c:url value="/new" />">Home</a></li>
						<li class="nav-item">
						<a class="nav-link" href="<c:url value="/newoffers" />">Show</a></li>
						<li class="nav-item">
						<a class="nav-link" href="<c:url value="/createoffer" />">New</a></li>
